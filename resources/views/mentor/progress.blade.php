...
<head>
    ...
    <title>Input Progress - Kampong Inggris Pare</title>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Input Student Progress</h3>
                <p class="text-subtitle text-muted">Update student scores and provide feedback.</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index-mentor.html">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Input Progress</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Progress Input Form</h4>
                    </div>
                            ...
                            <form class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <select class="choices form-select" id="material-select">
                                                <option value="">Select Material</option>
                                                <option value="Speaking Practice">Speaking Practice</option>
                                                <option value="Reading Comprehension">Reading Comprehension</option>
                                                <option value="Grammar Essentials">Grammar Essentials</option>
                                        ...
                                        <div class="col-md-4">
                                            <label for="achievement-score">Achievement Score (%)</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="achievement-score" class="form-control" name="achievement-score" placeholder="Enter score (0-100)" min="0" max="100">
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="last-activity" class="form-control" name="last-activity" placeholder="e.g., Completed Chapter 2 Quiz">
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <textarea class="form-control" id="feedback-notes" rows="4" placeholder="Provide constructive feedback for the student..."></textarea>
                                        </div>

                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-1 mb-1">Submit Progress</button>
