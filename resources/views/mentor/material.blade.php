...
<head>
  ...
  <link rel="stylesheet" href="{{ asset("templates/backend/")  }}/assets/extensions/quill/quill.snow.css">
  <link rel="stylesheet" href="{{ asset("templates/backend/")  }}/assets/extensions/filepond/filepond.css">
  <link rel="stylesheet" href="{{ asset("templates/backend/")  }}/assets/extensions/filepond-plugin-image-preview/filepond-plugin-image-preview.css">
</head>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Material Upload Form</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="material-title" class="form-control" name="title" placeholder="e.g., Advanced Speaking Practice">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="material-level">Level</label>
                                    <select class="form-select" id="material-level">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div id="full-editor" style="height: 150px;">
                                        <p>Provide a brief description of the material here.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <p class="card-text">Upload PDF, PPT, or video files here.</p>
                                    <input type="file" class="multiple-files-filepond" multiple id="material-file">
                                </div>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const inputElement = document.querySelector('input[type="file"].multiple-files-filepond');
