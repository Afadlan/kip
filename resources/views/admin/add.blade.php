                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <div class="profile-pic-container">
                                            <img id="profile-pic-preview" class="profile-pic" src="{{ asset("templates/backend/")  }}/assets/static/images/faces/1.jpg" alt="Profile Picture">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="full-name-column" class="form-control" placeholder="Enter full name" name="fname-column" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Email</label>
                                            <input type="email" id="email-id-column" class="form-control" name="email-id-column" placeholder="Enter email address" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="password-column">Password</label>
                                            <input type="password" id="password-column" class="form-control" placeholder="Enter password" name="password-column" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="confirm-password-column">Confirm Password</label>
                                            <input type="password" id="confirm-password-column" class="form-control" placeholder="Confirm password" name="confirm-password-column" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('reset', function() {
            ...
            setTimeout(() => {
                preview.src = "{{ asset("templates/backend/")  }}/assets/static/images/faces/1.jpg";
            }, 0);
        });
    });
</script>
